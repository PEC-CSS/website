...
import DialogPopup from "../../components/common/CreatePopup/CreatePopup";
      ...
      <form className={styles.parent} onSubmit={handleSubmit}>
        ...
        <div className={styles.sectionWrapper}>
          <div className={styles.flowSection}>
            <div className={styles.smallText}>Enter New Password</div>
        ...
        <div className={`${styles.buttonGroup} ${styles.flowSection}`}>
          <div className={styles.registerButton}>
            <button type="submit" disabled={loading}>
              {!loading ? (successMessage ? "Password Changed" : "Change Password") : "Changing..."}
            </button>
          </div>
        </div>
      </form>
